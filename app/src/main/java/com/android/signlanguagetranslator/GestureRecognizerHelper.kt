...
class GestureRecognizerHelper(
    ...
    fun recognizeLiveStream(
        ...
        val matrix = Matrix().apply {
            ...
            // Handle horizontal flipping based on the camera lens facing
            postScale(
                if (isFrontFacing) -1f else 1f, // Flip horizontally for front camera
                1f,
                imageProxy.width.toFloat() / 2,  // Pivot point for scaling
